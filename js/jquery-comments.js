    ...
    var Comments = {
        ...
        getDefaultOptions: function() {
            return {
                ...
                textareaPlaceholderText: 'הוסף תגובה',     
                newestText: 'כל התגובות',     
                oldestText: 'תגובות אחרונות',     
                popularText: 'דיונים פופולריים',       
                attachmentsText: 'קישורים שימושיים',       
                sendText: 'שלח',     
                replyText: 'כתוב תגובה',       
                editText: 'עריכה',     
                editedText: 'נערך',     
                youText: 'אתה',       
                saveText: 'שמור',     
                deleteText: 'מחק',     
                viewAllRepliesText: 'צפה בכל התגובות',        
                hideRepliesText: 'הסתר תגובה',      
                noCommentsText: 'אין תגובה',        
                noAttachmentsText: 'אין קבצים מצורפים',      
                attachmentDropText: 'זרוק את הקבצים לכאן',        
